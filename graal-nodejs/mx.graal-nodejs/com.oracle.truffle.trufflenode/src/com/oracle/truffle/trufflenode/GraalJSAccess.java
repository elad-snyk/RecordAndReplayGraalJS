...
public final class GraalJSAccess {
    ...
    public boolean valueInstanceOf(Object left, Object right) {
        if (left instanceof DynamicObject) {
            ...
            if (hasInstance == Undefined.instance) {
                ...
                trace("valueInstanceOf",hasInstance, function, new Object[]{left});
    ...
    public Object functionNewInstance(Object function, Object[] arguments) {
        ...
        trace("functionNewInstance",function,null, arguments);
    ...
    ///////////////////////////////////////////////////////////////
    private static volatile int ident = 0;
    private void trace(String traceId, Object function, Object receiver, Object[] arguments) {
     /* if(RecordAndReplyConstants.TRACING) {
        String name = JSFunction.getFunctionName((DynamicObject)function);
        MaterializedFrame mf = JSFunction.getEnclosingFrame((DynamicObject)function);

        StringBuilder line = new StringBuilder();


        line.append(ident++).append(":").append(traceId).append(":").append(name).append(":");
        if(JSFunction.isAsyncFunction((DynamicObject)function)) {
          line.append("async");
        } else {
          line.append("not async");
        }
        line.append(":");


        JSRealm realm = JSFunction.getRealm((DynamicObject)function);
        Object classPrototype = JSFunction.getClassPrototype((DynamicObject)function);

        NodeJSAgent agent = (NodeJSAgent)realm.getAgent();
        Thread nodeThread = agent.getThread();

        SourceSection ss = functionGetSourceSection(function);
        RootCallTarget rct = (RootCallTarget)JSFunction.getCallTarget((DynamicObject)function);

        RootNode rn = rct.getRootNode();
        line.append("|" + rn.getDescription() + "|");
        JSFunctionData data = JSFunction.getFunctionData((DynamicObject)function);
        line.append("|" + data.getName() + "|");

        String sourceName = "";
        if(ss != null && ss.getSource() != null) {
          sourceName = ss.getSource().getName();
        }
        line.append(nodeThread.getId()).append(":").append(sourceName).append(":").append("linenumber = ").append(functionGetScriptLineNumber(function));
        line.append(": column = " + functionGetScriptColumnNumber(function) + ":");
        line.append("~~~" + Thread.currentThread().getId() + "~" + Thread.currentThread().hashCode() +  "~~~~");

       /* for(Thread t : Thread.getAllStackTraces().keySet()) {
          System.out.println(t.getId() + "____" + t.hashCode() + t.getName());
        }*/
        /* try {
          RecordAndReplyConstants.SERIALIZER.writeObject(function);
        } catch (IOException e) {
          e.printStackTrace();
        }*/

      /*  for(FrameSlot sl : mf.getFrameDescriptor().getSlots()) {
          line.append(sl.toString()).append(":");
        }*/
/*
    ...
    public Object functionCall(Object function, Object receiver, Object[] arguments)  {
        trace("functionCall", function, receiver, arguments);
    ...
    public Object scriptCompilerCompileFunctionInContext(Object context, String sourceName, String body, Object[] arguments, Object[] exts, Object hostDefinedOptions) {
        ...
        if (snapshot == null) {
            ...
            trace("scriptCompilerCompileFunctionInContext",fn,null, null);
    ...
    private Object scriptRunInternal(ScriptNode scriptNode, Object[] arguments) {
        ...
        JavaScriptRootNode wrapperNode = new JavaScriptRootNode() {
            ...
            public Object execute(VirtualFrame frame) {
                ...
                trace("scriptRunInternal",moduleFunction,thisObject,args);
    ...
    public void isolateRunMicrotasks() {
        pollWeakCallbackQueue(false);
        try {
            //System.err.println("isolateRunMicrotasks");
    ...
    public void isolateEnqueueMicrotask(Object microtask) {
      ...
      SourceSection ss = functionGetSourceSection(microtask);
      System.out.println("enquee");
      if(ss != null){
        System.out.println("hash:" + ss.hashCode());
      }
    ...
    public Object promiseResolverNew(Object context) {
        ...
        trace("promiseResolverNew", resolverFactory,null, null);
    ...
    public boolean promiseResolverResolve(Object resolver, Object value) {
        ...
        Object[] args = JSArguments.create(Undefined.instance, resolve, value);
        trace("promiseResolverResolve",value,null,args);
    ...
    public boolean promiseResolverReject(Object resolver, Object value) {
        ...
        Object[] args = JSArguments.create(Undefined.instance, reject, value);
        trace("promiseResolverReject",value,null,args);
        JSFunction.call(args);
        return true;
    }
